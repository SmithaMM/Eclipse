...
import com.xworkz.electioncomission.exception.HouseFullRunTimeException;
...
public class Theatre {
	...
	public boolean bookTicketGandhiClass(String movieName, TicketType ticketType, int totalTickets) {
	...
	public boolean bookTicketMiddleClass(String movieName, TicketType ticketType, int totalTickets) {
		System.out.println("invoked bookTicket");
	...
	public boolean bookTicketBalcony(String movieName, TicketType ticketType, int totalTickets) {
		System.out.println("invoked bookTicket");
